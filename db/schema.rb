...
ActiveRecord::Schema.define(version: 20171209213527) do
  ...
  add_index "wagers", ["player_id"], name: "index_wagers_on_player_id"
  add_index "wagers", ["round_id"], name: "index_wagers_on_round_id"
